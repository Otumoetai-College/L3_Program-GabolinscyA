...
class SampleApp(tk.Tk):
    ...
    def finalise_new_team1(self, root):
        ...
        SampleApp.show_frame(app, "CreateTeamPage")

    def set_dungeon_team(self, decoded_dungeoneer_team1):
        current_team = open("C:/Users/{}/Documents/L2_ASSIGNMENT_RPG/account_data_dungeon_team.txt".format(computer_username), "a")
...
class DungeonDelve(tk.Frame):
    ...
    def enter_dungeon_confirmation(self):
        ...
        yesButton = tk.Button(root, text="Yes", command=lambda: SampleApp.set_dungeon_team(SA, decoded_dungeoneer_team1))
