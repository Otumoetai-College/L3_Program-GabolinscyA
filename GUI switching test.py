...
class MainMenu(tk.Frame):
    def __init__(self, parent, controller):
        ...
        buttonTeam.grid(row=2, column=1, sticky="ew")
        buttonCredit.grid(row=3, column=2)
        buttonH2P.grid(row=4, column=3)
        buttonLeaderboard.grid(row=5, column=4)
        buttonQuit.grid(row=6, column=5)
